...
export const LevelIntroScreen: React.FC<LevelIntroScreenProps> = ({ onComplete }) => {
  ...
  return (
    <div style={{ maxWidth: "640px", margin: "40px auto", padding: "0 16px" }}>
      ...
      <div className="card blue" style={{ marginBottom: "24px", textAlign: "center" }}>
        <p style={{ color: "var(--head)", fontStyle: "italic", fontSize: "16px", lineHeight: "1.6", margin: "0 0 8px" }}>
          "Wake up, sleeper, rise from the dead, and Christ will shine on you."
        </p>
        <span style={{ fontSize: "13px", color: "var(--body)" }}>Ephesians 5:14</span>
      </div>
      ...
      <div className="card" style={{ display: "flex", flexDirection: "column", gap: "16px", lineHeight: "1.7" }}>
        ...
        <p style={{ margin: 0 }}>
          You are not behind. You are not too far gone. You are exactly where you need to be to begin. <span style={{ color: "var(--gold)", fontWeight: "700" }}>Welcome to Level 1.</span>
        </p>
      </div>
